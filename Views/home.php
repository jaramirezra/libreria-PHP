...
<body>
    <div class="container mt-4">
        <div class="list-container">
            <h1>Mis sitio favoritos</h1>
            <div class="d-grid gap-2 d-md-block mt-4 mb-4">
                <a href="create" class="btn btn-outline-success">Crear</a>
                <a href="categories" class="btn btn-outline-success">Categoria</a>
            </div>
                ...
                <tbody>
                    <?php foreach ($sites as $site): ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit?id=<?= $site['id']; ?>" class="btn btn-sm btn-outline-primary">Editar</a>
                                <form method="POST" action="delete?id=<?= $site['id']; ?>" style="display:inline;">
